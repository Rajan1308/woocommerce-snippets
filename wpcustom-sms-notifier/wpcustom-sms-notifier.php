...
/**
 * Plugin Name: WPCustom SMS Notifier
 ...
 */
 ...
 add_action( 'woocommerce_order_status_changed', 'WPCusrom_send_sms_on_new_order_status', 10, 4 );
 
 // Event of the order note
 add_action( 'woocommerce_new_customer_note_notification', 'WPCusrom_send_sms_on_new_order_notes', 10, 1 );
 
 
 function WPCusrom_send_sms_on_new_order_status( $order_id, $old_status, $new_status, $order  ) {
     ...
     WPCusrom_send_sms_to_customer( $phone, $default_sms_message, $shopname );
     
 }
 
 function WPCusrom_send_sms_on_new_order_notes( $email_args ) {
     ...
     WPCusrom_send_sms_to_customer( $phone, $note, $shopname );
 }
 
 function WPCusrom_send_sms_to_customer( $phone = 'NULL', $default_sms_message, $shopname ) {
